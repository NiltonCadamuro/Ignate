...
const GET_LESSON_BY_SLUG_QUERRY = gql`
...
interface GetLssonBySlugResponse {
    lesson: {
        title: string;
        videoId: string;
        description: string;
...
export function Video(props: VideoProps){
    const { data } = useQuery<GetLssonBySlugResponse>(GET_LESSON_BY_SLUG_QUERRY, {
        variables: {
                ...
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img src={data.lesson.teacher.avatarURL} alt="Foto Perfil Professor" className="h-16 w-16 rounded-full border-2 border-blue-500"/>
